...
void showLanguageSelectDialog(BuildContext context) {
  ...
  showCupertinoModalPopup(
      context: context, builder: (context) => LanguageSelectDialog(data: data));
}
...
class LanguageSelectDialog extends StatelessWidget {
  ...
  Widget _buildItem(BuildContext context, int index) {
    ...
    Locale? blocLocale = BlocProvider.of<AppConfigBloc>(context).state.locale;
    bool checked = locale == blocLocale;
