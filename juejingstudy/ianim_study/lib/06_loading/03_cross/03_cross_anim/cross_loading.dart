...
class CrossLoadingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final double end = size.height / 2 - itemWidth / sqrt(2) + 20;
  ...
  void drawItem(
      Canvas canvas, double begin, double end, Color color, bool vertical,
      {Curve curve = Curves.easeIn}) {
    Animatable<double> tween = TweenSequence([
