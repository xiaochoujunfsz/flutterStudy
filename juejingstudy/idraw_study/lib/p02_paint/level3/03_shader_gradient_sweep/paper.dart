...
class PaperPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint.shader = ui.Gradient.sweep(
        const Offset(80 + 150.0 * 0, 80), colors, pos, TileMode.clamp, pi / 2, pi);
    canvas.drawCircle(
    ...
    paint.shader = ui.Gradient.sweep(
        const Offset(80 + 150.0 * 1, 80), colors, pos, TileMode.repeated, pi / 2, pi);
    canvas.drawCircle(
    ...
    paint.shader = ui.Gradient.sweep(
        const Offset(80 + 150.0 * 2, 80), colors, pos, TileMode.mirror, pi / 2, pi);
    canvas.drawCircle(
    ...
    paint.shader = ui.Gradient.sweep(
        const Offset(80 + 150.0 * 3, 80), colors, pos, TileMode.clamp);
    canvas.drawCircle(
