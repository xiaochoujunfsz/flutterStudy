      ...
      body: Padding(
        ...
        child: Wrap(
          ...
          children: books
              .map((e) => Alertable(
                    message: e,
                    introduction: introductionMap[e] ?? '暂无简介',
                  ))
              .toList(),
        ),
      ),
...
class Alertable extends StatefulWidget {
  ...
  const Alertable({Key? key, required this.message, required this.introduction})
      : super(key: key);
  ...
  void _createNewEntry() {
    ...
    if (renderObject != null && renderObject is RenderBox) {
      ...
      if (outLeft) {
        ...
        targetOffset = Offset(topLeftOffset.dx - boxWidth + targetSize.width,
